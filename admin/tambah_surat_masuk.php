        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="proses.php?id=suratmasuk" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="tgl_terima" rows="6" placeholder="Enter ...">
                            </div>

                            <div class="form-group">
                                <label>Asal Surat</label>
                                <input class="form-control" name="asal_surat" rows="6" placeholder="Enter ...">
                            </div>
