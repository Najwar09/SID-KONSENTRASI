            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <a class="btn bg-yellow" style="margin:10px 0;" onclick="window.open('data-suratkeluar-excel.php')">Convert Ke Excel</a>
                        <a class="btn bg-blue" style="margin:10px 0;" onclick="window.open('data-suratkeluar-pdf.php')">Convert Ke PDF</a>
