            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <a class="btn bg-yellow" style="margin:10px 0;" onclick="window.open('data-pindah-excel.php')">Convert Ke Excel</a>
                        <a class="btn bg-blue" style="margin:10px 0;" onclick="window.open('data-pindah-pdf.php')">Convert Ke PDF</a>
