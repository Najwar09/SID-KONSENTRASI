...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Data Lahiran</li>
        </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="proses.php?id=lahiran" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="nama" rows="6" placeholder="Enter ..." type="text">
                            </div>

                            <div class="form-group">
                                <label>Tanggal Lahiran</label>
                                <input class="form-control" name="tgl_lahiran" rows="6" placeholder="Enter ..." type="date">
                            </div>
