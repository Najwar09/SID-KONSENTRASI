<?php
    $conn = mysqli_connect("localhost", "root", "", "db_desa_v2");
    ...
    if ($_GET['id']=='penduduk') {
        ...
        $query2 = "INSERT INTO tb_data_penduduk VALUES('','$kk','$nik','$nama','$tempat_lahir','$tgl_lahir','$jkel','$desa','$rt','$rw','$agama','$status','$pekerjaan','$ket')";
    ...
    if ($_GET['id']=='kematian') {
        ...
        $query3 = "UPDATE tb_data_penduduk SET keterangan = 'mati' WHERE nik = '$nik'";
     ...
     if ($_GET['id']=='pindah') {
        ...
        $query2 = "INSERT INTO tb_data_pindah VALUES('','$nama','$nik','$tgl_pindah','$alasan','$alamat_baru')";
        $hasil = mysqli_query($conn,$query2);

        $query3 = "UPDATE tb_data_penduduk SET keterangan = 'pindah' WHERE nik = '$nik'";
        $hasil = mysqli_query($conn,$query3);
    ...
    if ($_GET['id']=='suratmasuk') {
        ...
        $query2 = "INSERT INTO tb_surat_masuk VALUES('','$no_surat','$tgl_surat','$tgl_terima','$asal_surat','$perihal')";
        $hasil = mysqli_query($conn,$query2);
    ...
    if ($_GET['id']=='editpenduduk') {
        ...
        echo '<script>alert("Berhasil Memperbaharui Data Penduduk!");history.go(-2);</script>';
    }
