...
$query = "SELECT * FROM tb_data_penduduk WHERE keterangan = 'hidup'";
                    ...
                    <form action="proses.php?id=kematian" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="nama_penduduk" name="nama_penduduk" class="form-control">
                                    <option selected>-------Pilih-------</option>
                                    <?php
                                    foreach ($hasil as $isi) {
                                    ?>
                                        <option value="<?= $isi['nama_lengkap']; ?>"><?= $isi['nama_lengkap']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="nik" name="nik" class="form-control">
                                    ...
                                    foreach ($hasil as $isi) {
                                    ?>
                                        <option value="<?= $isi['nik']; ?>"><?= $isi['nik']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
