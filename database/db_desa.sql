...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Des 2023 pada 17.58
...
INSERT INTO `tb_data_penduduk` (`id_penduduk`, `no_kk`, `nik`, `nama_lengkap`, `tempat_lahir`, `tanggal_lahir`, `jkel`, `desa`, `rt`, `rw`, `agama`, `status_nikah`, `pekerjaan`, `keterangan`) VALUES
(14, '66666', 666661, 'najwar', 'makassar', '2016-06-14', 'Pria', 'kampung buyang', '01', '01', 'islam', 'belum menikah', 'belum kerja', 'hidup'),
(15, '66666', 666662, 'awi', 'makassar', '2003-01-07', 'pria', 'kampung buyang', '01', '01', 'islam', 'belum menikah', 'belum kerja', 'hidup'),
(16, '7777', 777772, 'abiyan syahran', 'malino', '2023-12-13', 'pria', 'mariso', '09', '09', 'islam', 'belum menikah', 'belum kerja', 'pindah'),
(17, '909090', 90009090, 'annisa', 'toraja', '2023-12-20', 'wanita', 'fadskfk', '98', '989', 'islam', 'belum menikah', 'belum kerja', 'mati');
...
INSERT INTO `tb_data_pindah` (`id_pindah`, `nama`, `nik`, `tgl_pindah`, `alasan`, `alamat_baru`) VALUES
(7, 'abiyan syahran', 777772, '2023-12-21', 'karena kerja di luar kota', 'jl cendana no1 ');
...
(6, 'annisa', '90009090', '2023-12-14', 'klklkllkl', 'klklkl');
...
(4, 'abiyan syahranfad', '2023-12-13', 'Pria'),
(5, 'annisa', '2023-12-20', 'wanita');
...
INSERT INTO `tb_surat_keluar` (`id_keluar`, `no_surat`, `perihal`, `tujuan`, `tgl_surat`, `tgl_kirim`) VALUES
...
INSERT INTO `tb_surat_masuk` (`id_masuk`, `no_surat`, `tgl_surat`, `tgl_terima`, `asal_surat`, `perihal`) VALUES
(2, 'fadsfads', '2023-11-16', '2023-11-07', 'fadsf', 'adfasd');
...
--
ALTER TABLE `tb_kematian`
  MODIFY `id_mati` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_lahiran`
  MODIFY `id_lahiran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
